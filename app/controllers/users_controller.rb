class UsersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user.save
        format.html { redirect_to @user, notice: 'Usuário foi cadastrado com sucesso.' }
  ...
  def update
    respond_to do |format|
      if @user.update(user_params)
        format.html {redirect_to improvements_path, notice: 'Usuário foi atualizado com sucesso.' }
...
#####################################################################
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:name, :email, :password, :password_confirmation, :permission, :sub_name, :admin)
    end
